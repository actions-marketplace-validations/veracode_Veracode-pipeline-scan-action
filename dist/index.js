...
function run(parameters) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(0, fs_1.existsSync)('results.json')) {
            ...
            try {
                (0, fs_1.writeFileSync)(emptyResultsFile, emptyResultsString);
            }
            catch (error) {
        ...
        if ((0, fs_1.existsSync)(rootDirectory + '/' + parameters.json_output_file && rootDirectory + '/' + parameters.filtered_json_output_file && rootDirectory + '/' + parameters.summary_output_file)) {
